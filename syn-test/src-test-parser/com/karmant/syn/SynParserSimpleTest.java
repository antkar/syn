 ...
 */
public class SynParserSimpleTest extends TestCase {
	...
	public void testObjectValue() throws Exception {
		SynParser synParser = createParserStr(
				"@file : (value)* ;" +
				"value :" +
				"'red' <com.karmant.syn.SynParserSimpleTest$Colors.RED> |" +
				"'green' <com.karmant.syn.SynParserSimpleTest$Colors.GREEN> |" +
				"'blue' <com.karmant.syn.SynParserSimpleTest$Colors.BLUE> |" +
				"'true' <com.karmant.syn.SynParserSimpleTest.TRUE> |" +
				"'false' <com.karmant.syn.SynParserSimpleTest.FALSE> |" +
				"'int' <com.karmant.syn.SynParserSimpleTest.INT> |" +
				"'long' <com.karmant.syn.SynParserSimpleTest.LONG> |" +
				"'double' <com.karmant.syn.SynParserSimpleTest.DOUBLE> |" +
				"'string' <com.karmant.syn.SynParserSimpleTest.STRING> |" +
				"'object' <com.karmant.syn.SynParserSimpleTest.OBJECT> ;");
			...
			throws SynException
	{
		...
		for (int i = 0; i < valuesCount; ++i) {
			...
			if (value instanceof String) {
				assertEquals((String) value, objectNode.getString(key));

...
public class TokenStreamTest extends TestCase {
	...
	public void testTokenPos() throws Exception
	{
				...
				Reader reader = new InputStreamReader(in))
		{
			...
			checkTokenPos(tokenStream, sourceDescriptor, 2, 2, 7);
			checkTokenPos(tokenStream, sourceDescriptor, 3, 3, 2);
			checkTokenPos(tokenStream, sourceDescriptor, 3, 6, 1);
			checkTokenPos(tokenStream, sourceDescriptor, 3, 7, 1);
			checkTokenPos(tokenStream, sourceDescriptor, 3, 8, 1);
			checkTokenPos(tokenStream, sourceDescriptor, 3, 10, 8);
			checkTokenPos(tokenStream, sourceDescriptor, 3, 18, 1);
			checkTokenPos(tokenStream, sourceDescriptor, 3, 20, 4);
			checkTokenPos(tokenStream, sourceDescriptor, 3, 25, 1);
			checkTokenPos(tokenStream, sourceDescriptor, 3, 26, 5);
			checkTokenPos(tokenStream, sourceDescriptor, 3, 31, 1);
			checkTokenPos(tokenStream, sourceDescriptor, 3, 32, 1);
			checkTokenPos(tokenStream, sourceDescriptor, 4, 1, 2);
			checkTokenPos(tokenStream, sourceDescriptor, 4, 4, 2);
			checkTokenPos(tokenStream, sourceDescriptor, 4, 7, 2);
			checkTokenPos(tokenStream, sourceDescriptor, 4, 10, 2);
			checkTokenPos(tokenStream, sourceDescriptor, 5, 4, 0);
			checkTokenPos(tokenStream, sourceDescriptor, 5, 4, 0);
		}
	}

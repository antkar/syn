...
import com.karmant.syn.ObjectNode.ObjectEntry;

/**
 * Object parser action. Produces an {@link ObjectNode}.
 */
class ParserObjectAction implements IParserAction {
    
    /** Null object. Contains no attributes. */
    static final ParserObjectAction NULL = new ParserObjectAction(
     ...
     */
    ParserObjectAction(Map<String, IParserGetter> getterMap, Collection<IParserGetter> embeddedGetters) {

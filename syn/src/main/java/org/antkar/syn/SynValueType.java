...
public enum SynValueType {
    ...
    {
        @Override
        public <T> T invokeProcessor(ValueTypeProcessor<T> processor) throws SynException {
     ...
     */
    public abstract <T> T invokeProcessor(ValueTypeProcessor<T> processor) throws SynException;
}

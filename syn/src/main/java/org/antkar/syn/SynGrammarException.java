 ...
 */
public final class SynGrammarException extends SynTextException {
    private static final long serialVersionUID = 3530779109153425091L;

    public SynGrammarException(TextPos textPos, String message, Throwable cause) {
        super(textPos, message, cause);
    }

    public SynGrammarException(TextPos textPos, String message) {

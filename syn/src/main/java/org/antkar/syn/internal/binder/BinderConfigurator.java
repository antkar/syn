...
import org.antkar.syn.internal.binder.lookup.LookupInitializer;
 ...
 */
public final class BinderConfigurator {
     ...
     */
    public static <T> BinderConfiguratorResult<T> makeConfiguration(
            Class<T> classToBind,

 ...
 */
public final class BinderEngine<T> {
     ...
     */
    public static <T> T createObjects(BinderConfiguration<T> config, SynNode rootNode) throws SynBinderException {
     ...
     */
    public List<BoundObject> getObjsForClass(Class<?> cls) {
     ...
     */
    public Collection<Class<?>> getClassesOfObjs() {
